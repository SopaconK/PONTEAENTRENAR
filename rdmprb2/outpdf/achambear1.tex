...
\end{problem}
\begin{problem}[Hong Kong TST 2021/2.1]
...
\end{problem}
\begin{problem}[2018-2019 ACM-ICPC Brazil Subregional Programming Contest L]
...
\end{problem}
\begin{problem}[Dutch TST 2016/2.1]
...
\end{problem}
\begin{problem}[India STEMS 2025/A6]
...
\end{problem}
\begin{problem}[Saudi Arabia JBMO TST 2021/4 ]
...
\end{problem}
\begin{problem}[EGOI 2022/4 Tourists]
\url{https://codeforces.com/gym/104229/problem/D} 
\end{problem}
\begin{problem}[Virtual Brasil PES 29-1-25 ]

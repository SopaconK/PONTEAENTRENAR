...
\begin{itemize}
    ...
    \item En general, la suma de los \'angulos internos de un poligono de $n$ lados es  $180(n-2)$
    \item En un tri\'angulo no degenerado $ABC$ se tiene que $AB=AC \Longleftrightarrow \angle ABC = \angle ACB$
...
\begin{theorem}
    ...
    \end{center}
\end{theorem}
Esto incluye que si un angulo inscrito $\angle ACB =90^o$, entonces $BC$ es diametro.
Particularmente
\begin{theorem}
...
Si tienes las dos tangentes $PA, PB$ a una circunferencia desde $P$, demuestra que $PA=PB$.
...
Definamos estos dos puntos en un triangulo $ABC$.
\begin{itemize}
...
\section{Problemas}
\epigraph{Incluso si el polvo se amontona, puede crear una montaña}{}
...
\problemdiff{5}
\begin{problem}[\gad]% [USA TSTST 2023/1 \gad] % creo
